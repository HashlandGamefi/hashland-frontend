    ...
    list: [
      {
        ...
        downloadLink: "https://cdn.hashland.com/apk/HashWarfare_main_2.0.0.apk",
      },
      {
        isShow: true, // 是否显示该平台
...
export const GameUpdateLog = [
  {
    version: "2.0.0",
    update: "20-07-2022",
    log: "Season 9: Summoner level cap 50, Chapter 1-20, lasts 12 days",
  },
  {
    version: "1.9.0",
    update: "13-06-2022",
    log: "Season 8: Summoner level cap 50, Chapter 1-20, lasts 12 days",
  },
  {
    version: "1.8.0",
    update: "19-05-2022",
    log: "Season 7: Summoner level cap 40, Chapter 1-15, lasts 12 days",
  },
  {
    version: "1.7.0",
    update: "25-04-2022",
    log: "Season 6: Summoner level cap 40, Chapter 1-15, lasts 12 days",
  },
  {
    version: "1.6.0",
    update: "02-04-2022",
