export const message = {
  ...
  gameFi:{
    ...
    text7:"Email login",
    text8:"Can only be used to log in to the game",
    text9:"Email",
    text10:"Enter email",
    text11:"Password",
    text12:"Enter password",
    text13:"Sign In",
    text14:"No account yet? Click to register",
