export const message = {
  ...
  nftCard:{ // nft卡牌
    ...
    txt15:'每张卡牌都具有单独的ERC721标识，并且分别对应GameFi中角色人物（共4位）',
    txt16:'购买后获得1阶卡牌，可通过合成提升阶级，最高五阶',
    txt17:'同时卡牌也是锚定BTC、HC的算力凭证，持卡牌就相当于持有算力，卡牌等阶越高算力越多',
    txt18:'插入卡槽中即可享受BTC、HC挖矿收益，加成算力越多，奖励越多。（1阶卡牌只拥有BTC算力，没有HC算力）',

    txt19:'需要惊喜与期待，盲盒卡牌是你最好的选择',
    txt20:'盲盒卡牌可以开出任意阶级任意角色的卡牌，购买后可查看卡牌阶级及角色',
    txt21:'每次盲盒开出的卡牌阶级、角色都由合约中的随机函数确定，代码可在HashLand开源地址查看。卡牌阶级越高算力越多',
    txt22:'插入卡槽中即可享受BTC、HC挖矿收益，加成算力越多，奖励越多。（1阶卡牌只拥有BTC算力，没有HC算力）',
